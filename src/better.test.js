...
describe("Better Javascript", () => {
  test.skip("Array.prototype.toString() should return a comma separated list of the elements, with spaces after each comma", () => {
    expect([1, 2, 3].toString()).toBe("1, 2, 3");
    expect([1].toString()).toBe("1");
    expect([].toString()).toBe("");
  });

  test.skip("String.prototype.reverse", () => {
    expect("Hello".reverse).toBeDefined();
    expect("Hello".reverse()).toBe("olleH");
    expect("".reverse()).toBe("");
  });

  test.skip("Array.prototype.last", () => {
  ...
  test.skip("String.prototype.map", () => {
